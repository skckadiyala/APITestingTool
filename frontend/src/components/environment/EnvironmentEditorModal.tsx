          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <div className="flex items-center gap-4 flex-1">
              <input
                ...
                className="text-xl font-semibold bg-transparent border-none focus:outline-none text-gray-900 dark:text-gray-100 flex-1"
              />
              {isCreating && (
                      ...
                      >
                        ...
                        <div className="col-span-2">
                          <input
                            ...
                            placeholder="key"
                            className="w-full px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-primary-500"
                          />
                        </div>
