    ...
    <div className="flex items-center bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 overflow-x-auto">
      {tabs.map((tab) => (
        <div
          ...
          className={`
            group flex items-center gap-2 px-4 py-2 border-r border-gray-300 dark:border-gray-700 cursor-pointer
            min-w-[120px] max-w-[200px] hover:bg-gray-200 dark:hover:bg-gray-700
            ${activeTabId === tab.id 
        ...
        >
          ...
          <span
            className={`
              ...
              ${tab.method === 'POST' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300' : ''}
