      ...
      <div className="flex gap-2 items-center">
        ...
        <div className="relative" ref={settingsRef}>
          <button
            ...
            className="p-1.5 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors"
